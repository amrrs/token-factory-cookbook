...
| [Meeting Briefing Agent](meeting_briefing_agent/) | Researches a company and generates a cited pre-meeting brief with iterative gap analysis | LangChain · LangGraph · Nebius TF · Tavily · Streamlit |
