...
|-------|----------|------------|---------|------------|
| [Nemotron-3.5-Lightning](run_nemotron.ipynb)<br><br>[▶ Try it  @ TF](https://tokenfactory.nebius.com/playground?models=nvidia/Nemotron-3_5-Lightning) | NVIDIA | 30B total <br> 3B active | 262 K | Fast, low-cost MoE model built as the execution layer for always-on, long-running agents and high-throughput specialized tasks |
...
| [Nemotron-3-Ultra-550B-A55B](nemotron3-ultra-550b-a55b.md)<br><br>[▶ Try it  @ TF](https://tokenfactory.nebius.com/playground?models=nvidia/Nemotron-3-Ultra-550b-a55b) | NVIDIA | 550B total <br> 55B active | 256 K | Flagship hybrid MoE model optimized for the most demanding multi-agent AI and complex reasoning tasks |
