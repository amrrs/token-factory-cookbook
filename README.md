...
- [OpenEnv prompt optimization](integrations/openenv/prompt-optimization/README.md) — build an OpenEnv agent environment and optimize an agent's prompt against its reward with open models
